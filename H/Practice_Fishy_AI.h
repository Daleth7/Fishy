#ifndef PRACTICEAIFISH_HEA333IDER_
#define PRACTICEAIFISH_HEA333IDER_

#include "Fishy_GUI.h"

namespace GUI{
    class Practice_Fishy : public Fishy {
        public:
...
*/
            ...
            Practice_Fishy(const Practice_Fishy&)             = default;
            Practice_Fishy(Practice_Fishy&&)                  = default;
            Practice_Fishy& operator=(const Practice_Fishy&)  = default;
            Practice_Fishy& operator=(Practice_Fishy&&)       = default;
            virtual ~Practice_Fishy();
